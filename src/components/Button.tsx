...
function Button(props: { title: string, button_size: string, text_color: string, bg_color: string }): JSX.Element {
  const checkButtonSize = props.button_size ? props.button_size : "";
  const checkTextColor = props.text_color ? props.text_color : "text-dark";
  const checkBgColor = props.bg_color ? props.bg_color : "text-white";
